README for fordist_cleaned_nonTCGA_z_pli_rec_null_data.txt
    Written by Kaitlin Samocha (samocha@broadinstitute.org)
    Last updated 2016 January 13.


These data were generated using: ExAC.r0.3.nonTCGA.sites.vep.vcf.gz
The above file only includes a subset of the full ExAC dataset.

    
The file (fordist_cleaned_nonTCGA_z_pli_rec_null_data.txt) contains the following information for the canonical transcript of genes as defined in Ensembl v75 (GENCODE v19):
